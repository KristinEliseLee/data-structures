...
def sort_by_cohort(filename):
    ...
    for line in house_data:
        ...
        if cohort == "G":
            ...
            fall_15.append(f"{first} {last}")
        elif cohort == "Winter 2016":
            winter_16.append(f"{first} {last}")
        elif cohort == "Spring 2016":
            spring_16.append(f"{first} {last}")
        elif cohort == "Summer 2016":
            summer_16.append(f"{first} {last}")
    ...
    with open(filename) as house_data:
        for line in house_data:
            ...
            if cohort not in {"I", "G"}:
                student_list.append((f"{first} {last}", house, advisor, cohort))
...
def find_cohort_by_student_name(student_list):
    ...
    for student in all_students:
        if user_name == student[0]:
            print(f"{student[0]} was in the {student[-1]} cohort.")
            break
    else:
...
def find_house_members_by_student_name(student_list):
    ...
    for student in all_students:
        if user_name == student[0]:
            cohort = student[-1]
            house = student[1]
            print(f"{user_name} was in house {house} in the {cohort} cohort.")
    ...
    for student in all_students:
        if student[-1] == cohort and student[1] == house and student[0] != user_name:
            print(student[0])



find_house_members_by_student_name("cohort_data.txt")
